...
char solve()
{
    ...
    */   
    ...
    while (final_dist.size())
    {
        ...
        move_x = st_x - person_x, move_y = st_y - person_y;
        ...
        if ((flag1 || flag2) && (ans_dist.dist_p < ans_dist.dist_g || (ans_dist.dist_p == ans_dist.dist_g && ans_dist.dist_p > 1))) break;
        if (!flag1) break;
    }
